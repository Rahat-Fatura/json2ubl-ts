...
/**
 * KAMU + IHRACKAYITLI + 702 — kamu aracı kurum ihraç kayıtlı satış.
 * 07-temelfatura-ihrackayitli-702 ile yapısal aynı; profil farklı.
 */
export const input: SimpleInvoiceInput = {
  id: 'EXA2026000000017',
  uuid: 'e1a2b3c4-0017-4000-8017-000000000017',
  ...
  sender: {
    ...
    name: 'Sınır Tanımaz Tekstil A.Ş.',
    taxOffice: 'Üsküdar',
  ...
  customer: {
    ...
    name: 'T.C. Ticaret Bakanlığı — DTSŞ Aracısı',
    taxOffice: 'Çankaya',
    address: 'Söğütözü Caddesi No:52',
    district: 'Çankaya',
    city: 'Ankara',
    zipCode: '06530',
  },
  ...
  lines: [
    {
      name: 'İhraç Kayıtlı Tekstil Ürünü — DTSŞ Aracılığıyla',
      quantity: 100,
      price: 5,
      unitCode: 'Adet',
      kdvPercent: 0,
